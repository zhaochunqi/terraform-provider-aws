...
- Review the contents of the pull request and ensure the change follows the relevant section of the [Contributing Guide](contributing/contribution-checklists.md)
...
- Run relevant acceptance testing ([locally](contributing/running-and-writing-acceptance-tests.md#running-an-acceptance-test) or in TeamCity) against AWS Commercial and AWS GovCloud (US) to ensure no new failures are being introduced
